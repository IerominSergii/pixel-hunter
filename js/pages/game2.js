...
const game2Screen = createElement(game2Template);

const gameForm = game2Screen.querySelector(`.game__content`);
...
addEventListenerToBackArrow(game2Screen);
